...
--
-- Name: customers_salor_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.customers_salor_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.customers_salor_id_seq OWNER TO freecodecamp;

--
-- Name: customers_salor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.customers_salor_id_seq OWNED BY public.customers.customer_id;
...
ALTER TABLE ONLY public.customers ALTER COLUMN customer_id SET DEFAULT nextval('public.customers_salor_id_seq'::regclass);
...
--
-- Name: customers_salor_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.customers_salor_id_seq', 89, true);
